  ...
  return (
    <View style={styles.panel}>
      <View style={styles.headline}>
        ...
        <MandiText variant="display">{formatMoney(available)}</MandiText>
      ...
      <View style={styles.grid}>
        <Cell label="Reserved" value={reserved} hint="Held for orders in flight" />
        <Cell label="Utilized" value={utilized} hint="Drawn and not yet repaid" />
      </View>
